      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;padding:24px;background:#0a0a0a;color:#fff;border-radius:12px;">
          <div style="margin-bottom:20px;">
            <span style="color:#c12129;font-size:20px;font-weight:bold;">Lamid</span>
          </div>
          ...
          <a href="${actionUrl}" style="display:inline-block;background:#c12129;color:#fff;padding:10px 24px;border-radius:8px;text-decoration:none;font-size:14px;font-weight:600;">
            View on Lamid
          </a>
