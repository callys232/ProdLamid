  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="sustainable development, social inclusion, healthcare, gender equality, Lamid Consulting, community growth"
        />
        <meta name="lamid" content="Lamid Consulting" />
        <meta
          property="og:title"
          content="Sustainable Development | Lamid Consulting"
        />
        <meta
          property="og:description"
          content="Discover how Lamid Consulting fosters sustainable communities through strategic partnerships and inclusive growth."
        />
        <meta
          property="og:image"
          content="https://lamidconsulting.com/sustainable-icon.png"
        />
        <meta
          property="og:url"
