...
<head>
  ...
  <style>
    ...
    h1 { color: #C12129; margin-bottom: 4px; }
...
<body>
  ...
  <button onclick="window.print()" style="margin-top:24px; padding:10px 24px; background:#C12129; color:white; border:none; border-radius:8px; cursor:pointer; font-size:14px;">
    Print / Save PDF
  </button>
</body>
</html>`);
      ...
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <div className="flex gap-2 ml-auto">
          <select
            ...
            className="bg-gray-900 border border-gray-700 rounded-xl px-3 py-2 text-sm text-gray-300 focus:outline-none focus:border-[#C12129]"
          >
            ...
            <div className="flex items-start justify-between mb-6">
              <div>
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-[#C12129] font-black text-xl tracking-tight">LAMID</span>
