  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="human capital development, recruitment, training, leadership, soft skills, entrepreneurship, marketing, sales, Lamid Consulting"
        />
        <meta name="lamid" content="Lamid Consulting" />
        <meta
          property="og:title"
          content="Human Capital Development | Lamid Consulting"
        />
        <meta
          property="og:description"
          content="Explore Lamid Consulting's approach to attracting talent, training leaders, and building globally competitive teams."
        />
        <meta
          property="og:image"
          content="https://lamidconsulting.com/human-capital-icon.png"
        />
        <meta property="og:url" content="https://lamidconsulting.com/hcd" />
        <meta name="twitter:card" content="lamid hcd" />
          ...
          >
            ...
            <div className="flex-1 flex flex-col justify-center z-10">
              <p className="text-xs md:text-sm mb-3 md:mb-4 text-left sm:text-right">
                We light up your team and remodel their mindset and strategies
                to succeed beyond the 21st century.
              </p>
              <p className="text-xs md:text-sm mb-3 md:mb-4 text-left sm:text-right opacity-80 hover:opacity-100 transition duration-300">
                ...
                <strong>leadership, efficiency, and innovation</strong>,
                equipping employees with the necessary skills to navigate
                today's evolving business landscape. Whether it's enhancing
                problem-solving capabilities or strengthening collaboration, our
                expertise ensures <strong>measurable success</strong>.
              </p>
