        ...
        >
          ...
          >
            ...
            <Link
              ...
              className="px-7 py-3 rounded-full text-sm font-semibold border border-gray-300 dark:border-white/20 text-gray-600 dark:text-white/70 hover:border-[#C12129] hover:text-[#C12129] transition-colors"
            >
              Talk to an Expert
              <motion.span
