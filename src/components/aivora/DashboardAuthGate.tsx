  ...
  return (
    <main className="aivora-section min-h-screen flex flex-col items-center justify-center px-4 text-center">
      ...
      <div className="flex items-center gap-3">
        <Link href="/signin" className="px-6 py-2.5 rounded-xl text-sm font-semibold text-white bg-[#C12129] hover:bg-[#a01a20] transition-colors shadow-[0_0_14px_rgba(193,33,41,0.35)]">
          Sign In
        </Link>
        <Link href="/signup" className="px-6 py-2.5 rounded-xl text-sm font-semibold border border-[#C12129]/25 text-[#C12129] hover:bg-[#C12129]/8 transition-colors">
          Create Account
        </Link>
      </div>
