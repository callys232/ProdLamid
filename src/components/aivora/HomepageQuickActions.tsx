          ...
          >
            ...
            >
              ...
              <div className="px-6 pt-6 pb-7">
                ...
                <p className="text-[#C12129] text-[10px] tracking-[0.3em] uppercase font-bold mb-1">No credit card needed</p>
                      ...
                      <motion.div key={tool.id} variants={toolCard}>
                        ...
                        >
                          <motion.div className="absolute left-0 top-0 bottom-0 w-[3px] rounded-l-xl origin-top"
                            ...
                            transition={{ duration: 0.18 }} />
                          <span className="text-lg shrink-0 mt-0.5" style={{ color: tool.accent }}>{tool.icon}</span>
