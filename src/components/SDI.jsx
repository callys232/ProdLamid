...
const SDI = () => {
  ...
  return (
    <div>
      ...
      {/* Impact Section */}
      {showImpact && <div className="min-h-screen bg-black text-white">
            ...
            <section className="flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-3/4">
                ...
                <p className="text-gray-400 mb-4 pl-12">
                  ...
                  experience, we see job and wealth creation with cooperatives
                  as ...
                </p>
            ...
            <section className="flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-3/4">
                ...
                <p className="text-gray-400 pl-12">
                  ...
                  healthcare delivery and achieved organizational and financial
                  sustainability among five communities'
                  partnerships-for-health, after USAID's grant withdrawal by
                  Johns Hopkins' University, Centre for Educational Development
                  and Population Activities (CEDPA) and BASICS/Initiatives
                  Virginia.
                </p>
              </div>
            </section>
            ...
            <section className="flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-2/3">
                ...
                <p className="text-gray-400 mb-4">
                  ...
                  clusters around Shell's renewable energy assets, we achieved
