    ...
    <div className="bg-black text-white pb-12 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <Link href="/events">
            <button className="bg-orange-500 text-white px-6 py-2 rounded font-semibold hover:bg-[#2563EB] transition">
              View All Events
            </button>
          </Link>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {displayedEvents.map((event) => (
              ...
              >
                ...
                <div className="p-5">
                  <h3 className="text-lg font-semibold bg-gradient-to-r from-orange-400 to-blue-600 bg-clip-text text-transparent mb-2">
                    {event.title}
                  </h3>
