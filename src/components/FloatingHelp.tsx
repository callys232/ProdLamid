  ...
  return [
    {
      ...
      desc:  "Free AI health check — 7 dimensions",
    ...
    {
      label: "Proposal Drafter",
      desc:  "Free AI consulting proposal",
    ...
    },
    {
      ...
      icon: (
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="12" cy="12" r="9" /><polyline points="12 8 16 12 12 16" /><line x1="8" y1="12" x2="16" y2="12" />
        </svg>
      ),
    },
  ];
...
export default function FloatingHelp() {
  ...
  const menu = buildMenu(() => { setOpen(false); setModalOpen(true); });
      ...
      <div className="fixed bottom-6 left-6 z-50 flex flex-col items-start gap-2">
        ...
        >
          <span className="relative z-10 flex items-center gap-1.5">
            <span>{open ? "✕" : "✦"}</span>
            <span>{open ? "Close" : "Quick Tools"}</span>
          </span>
        </button>
      </div>
