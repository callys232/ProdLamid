...
const MOCK_JOBS: JobOpeningData[] = [
  {
    ...
    description:
      "Lead our sales enablement function to accelerate revenue growth.",
  },
  {
    _id: "mock-2",
  ...
  },
  {
    ...
    description:
      "Guide enterprise clients through digital and organizational transformation.",
  },
  {
    _id: "mock-4",
    ...
    description:
      "Facilitate project management certification programs for corporate cohorts.",
  },
];
...
export default function JobsTab() {
  ...
  const filtered = jobs.filter((j) => {
    if (
      search &&
      !`${j.title} ${j.department} ${j.skills.join(" ")}`
        .toLowerCase()
        ...
        {[
          ...
          >
            {(opts as string[]).map((o) => (
              <option key={o} value={o} className="bg-[#111111] text-gray-200">
                {o}
              </option>
            ))}
          </select>
