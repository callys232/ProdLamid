        ...
        {loading ? (
          ...
          <div className="text-center">
            ...
            <button
              ...
              className="text-sm bg-[#c21219] text-white px-4 py-1 rounded hover:bg-red-700"
            >
              Retry
            </button>
          </div>
          ...
          reviews.map((review) => (
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <h3 className="font-semibold text-[#c21219]">{review.reviewerName || review.name || "Anonymous"}</h3>
