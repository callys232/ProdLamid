...
import type { RealmPhase } from "@/mocks/sovereign";

interface Props { realms: RealmPhase[] }
...
export default function RealmTimeline({ realms }: Props) {
  return (
    <section className="px-6 py-12 border-t border-[#C9A84C]/10" style={{ background: "#070b14" }}>
      <div className="max-w-6xl mx-auto">
        <motion.div {...g(0)} className="mb-8">
          ...
          <h2 className="text-xl font-bold text-[#E8E0CC]" style={{ fontFamily: "Georgia, serif" }}>Multi-Realm Activation Sequence</h2>
          <p className="text-xs text-[#E8E0CC]/40 mt-1">Five sequential realms — each unlocking greater sovereign capacity</p>
        </motion.div>
