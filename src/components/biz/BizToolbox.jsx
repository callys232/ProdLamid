    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <main className="container mx-auto px-4 py-16">
        ...
        <header className="mb-12 text-center">
          <h1 className="text-2xl md:text-4xl font-bold mb-4 hover:text-gray-300 transition duration-300">
            <span className="text-red-700">B</span>usiness
            <span className="text-green-500"> E</span>xpansion
            <span className="text-blue-500"> S</span>trategy and
            <span className="text-amber-500"> T</span>echnology
        ...
        {/* Suite Tour Section */}
        <div className="mt-16">
          <h2 className="text-center text-xl md:text-2xl font-bold text-yellow-400 mb-8 hover:text-yellow-300 transition duration-300">
            SUITE TOUR
          </h2>

          <div className="flex flex-col md:flex-row justify-between items-stretch gap-4 mt-10">
            {/* Left Green Section */}
            <div className="bg-transparent border-2 border-green-500 rounded-lg p-6 md:w-1/3 relative hover:border-green-700 transition duration-300">
            ...
            <div className="bg-transparent border-2 border-orange-500 rounded-lg p-6 md:w-1/3 relative hover:border-orange-700 transition duration-300">
            ...
            {/* Right Blue Section */}
            <div className="bg-transparent border-2 border-blue-500 rounded-lg p-6 md:w-1/3 relative hover:border-blue-700 transition duration-300">
              ...
              <ul className="space-y-2 text-sm md:text-base">
                ...
                <li>
                  Set up robust financial, operational and control systems
                </li>
