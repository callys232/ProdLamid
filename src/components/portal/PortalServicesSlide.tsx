    ...
    <section className="relative bg-black text-white overflow-hidden py-16 px-4">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-10"
        >
          <p className="lamidone-gradient-text text-[10px] tracking-[0.35em] uppercase font-bold mb-3">
            The LAMID ONE
          </p>
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white leading-snug mb-3">
            One Ecosystem.{" "}
            <span className="lamidone-gradient-text">Every Way to Work.</span>
          </h2>
          ...
          >
            ...
            >
              ...
              <div className="p-7">
                ...
                <p className="lamidone-gradient-text text-[10px] tracking-[0.35em] uppercase font-bold mb-1">
                  Choose Your Path
                </p>
