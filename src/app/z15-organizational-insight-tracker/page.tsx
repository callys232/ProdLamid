...
export default function Z15Page() {
  ...
  return (
    <DashboardTierGate pillar="Z15 — Organizational Insight Tracker Engine" backHref="/z14-organizational-insight-consistency" backLabel="Organizational Insight Consistency">
