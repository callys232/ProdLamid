...
export default function Z09Page() {
  ...
  return (
    <DashboardTierGate pillar="Enterprise Consistency Check" backHref="/z08-enterprise-wide-intelligence-summary" backLabel="Enterprise-Wide Intelligence Summary">
