...
export default function Z07Page() {
  ...
  return (
    <DashboardTierGate pillar="Z07 — Transformation Identity Report Engine" backHref="/z06-transformation-progress-tracker" backLabel="Transformation Progress Tracker">
